  ...
  return (
    <MainLayout isDashboardPage={true}>
      <section className='py-12'>
        <div className='w-full flex items-center justify-between rounded-xl p-4 py-6 bg-gradient-linear-300 lg:px-10 lg:pr-16 xl:w-[75rem] 2xl:w-[90rem]'>
          <div className='w-1/2'>
            <h1 className='w-[max-content] font-[family-name:var(--font-general-sans-semibold)] text-2xl md:text-3xl lg:text-4xl xl:text-5xl'>
              Good morning Daniel!
            </h1>
            <p className='py-3 max-w-[26rem] lg:text-lg'>
          ...
          <Image
            ...
            className='w-full md:w-60 md:place-self-end lg:w-96'
          />
        </div>
      </section>
    </MainLayout>
